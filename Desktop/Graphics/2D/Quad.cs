...
namespace GameStack.Graphics {
	public class Quad : Drawable2D, IDisposable {
		...
		public Quad (Material material, Vector4 rect, Vector4 color, bool flipY = false) {
			_material = material;
			_color = color;
			...
			_vbuffer.Data = new [] {
				rect.X, rect.Y, 0f, _color.X, _color.Y, _color.Z, _color.W, 0f, flipY ? 1f : 0f,
				rect.Z, rect.Y, 0f, _color.X, _color.Y, _color.Z, _color.W, 1f, flipY ? 1f : 0f,
				rect.Z, rect.W, 0f, _color.X, _color.Y, _color.Z, _color.W, 1f, flipY ? 0f : 1f,
				rect.X, rect.W, 0f, _color.X, _color.Y, _color.Z, _color.W, 0f, flipY ? 0f : 1f
			};
			_vbuffer.Commit ();
